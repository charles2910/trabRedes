...
int main(int argc, char const *argv[])
{
	 ...
	 * código '267', id do sensor
	 * código '1', indica que é um sensor de temperatura
	 */
    char *id = "10022671\n\0";
	/**
	 * Primeira mensagem:
	 * código '10022674', mesma estrutura da mensagem inicial
	 * código '34.1', indica a leitura do sensor
	 */
	char *hello1 = "1002267134.1\n\0";
